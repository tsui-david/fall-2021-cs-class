...
"""
Exercise 1.
Draw "HELLO!" text onto the screen at coordinate (20, 20)
- https://web.archive.org/web/20210427222856/http://www.pygame.org/docs/ref/font.html#pygame.font.Font.render

Exercise 2.
Increment a variable count by 1 every loop, this will represent our raw score value.
ex:
101st loop
raw_score = 101

Exercise 3.
Create a function to return a nicely formatted string: "Score: <value>"
Since this value will increase very fast and be very high,
we want to divide by 10 and round down.

print the score string.

ex: 
raw_score = 101
score_string = "Score: 10"

Exercise 4.
Replace the string HELLO! with the score string.
"""
